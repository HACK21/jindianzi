...
*/
	...
	return array(
		...
		'categories_not_shown' => '一些有分类的点子将不会被显示',
		'categories_title' => '分类',
		'categories' => '分类',
		...
		'category_no_sub_error' => '^q 点子/秒 在这个分类没有子分类 - ^1设置子分类^2',
		'category_no_sub_to' => '移动没有子分类的点子到 ^ 中：',
		'category_no_subs' => '无',
		'category_none_error' => '^q 点子/秒 目前没有分类 - ^1设置分类^2',
		'category_none_to' => '移动没有分类的点子到：',
		'category_parent' => '父分类:',
		...
		'delete_category_reassign' => '删除这个分类并把该分类下的点子分配到：',
		'delete_category' => '删除该分类',
		'delete_field' => '删除该字段',
		'delete_hidden_complete' => '所有没有依赖关系(从属)的帖子已经被删除',
		'delete_hidden_note' => ' - 所有没有依赖关系(从属)的隐藏的回复，回复和评论',
		...
		'from_users' => '来自用户:',
		'general_title' => '普通',
		'hidden_answers_deleted' => '已删除 ^1的^2 无依赖(从属)的隐藏回复。',
		'hidden_comments_deleted' => '已删除 ^1的^2 隐藏的评论。',
		'hidden_questions_deleted' => '已删除 ^1的^2 无依赖(从属)的隐藏的点子。',
		'hotness_factors' => '点子热度评分：',
		'hidden_title' => '隐藏',
		...
		'no_link' => '无链接',
		'no_multibyte' => '编译安装的PHP版本不支持多字节字符串，搜索非罗马字符会出现点子',
		...
		'recalc_categories_recounting' => '重计数分类 ^1 的 ^2 点子...',
		...
		'recalc_posts_count' => '获取点子的 回复 和 评论 的总数...',
		'recalc_stop' => '停止重新计算',
		'recent_approve_title' => '最新等待的审核内容',
		'recent_hidden_title' => '最近隐藏的内容',
		'recount_posts_as_recounted' => '重计帖子 ^1的^2 回复数和热度...',
		'recount_posts_complete' => '成功重新计数了所有帖子。',
		'recount_posts_note' => ' - 每个帖子的回复数、投票、举报、热度',
		...
		'refill_events_refilled' => '^1 个点子已经重填，共 ^2 个...',
		'refill_events' => '重填事件流',
		'registration_fields' => '新增注册字段',
		'reindex_content' => '内容重索引',
		'reindex_content_note' => ' - 为搜索和相关点子提供相关信息',
