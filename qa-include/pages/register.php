...
//	Prepare content for theme
	...
	$qa_content['form'] = array(
		...
		'fields' => array(
			'handle' => array(
				...
				'tags' => 'name="handle" id="handle" required="required"',
			...
			'password' => array(
				...
				'tags' => 'name="password" id="password" required="required"',
			...
			'email' => array(
				...
				'tags' => 'name="email" id="email" required="required"',
	...
	foreach ($userfields as $userfield) {
        ...
        $qa_content['form']['fields'][$userfield['title']] = array(
            'label' => qa_html($label),
            'tags' => 'name="field_'.$userfield['fieldid'].'" required="required"',
            'value' => qa_html($value),
            'error' => qa_html(@$errors[$userfield['fieldid']]),
            'rows' => ($userfield['flags'] & QA_FIELD_FLAGS_MULTI_LINE) ? 8 : null,
        );
        if($userfield['title'] == 'location'){
            $qa_content['form']['fields'][$userfield['title']]['type'] = 'select';
            $qa_content['form']['fields'][$userfield['title']]['single_line'] = true;
            $qa_content['form']['fields'][$userfield['title']]['options'] = array(
                '北京' => '北京',
                '天津' => '天津',
                '山东' => '山东',
                '辽宁' => '辽宁',
