...
*/
	...
	{
        //TODO ???
        if($post['jackie_hide_vote_buttons']){
            return;
        }
...
//						break;
                        //TODO 显示中文名称
                        $userid= $post['raw']['_userid'] ? $post['raw']['_userid'] : $post['raw']['userid'];//qa_get_logged_in_userid();
                        $jackie_user_data = qa_db_select_with_pending(
                            qa_db_user_profile_selectspec($userid, true)
                        );
                        $post['who']['data'] = $jackie_user_data['name'];
                        $this->post_meta_who($post, $class);
                        break;
				}
			}
