...
*/
	{
        ...
        //TODO 增加分类到主菜单
        $temp_categories = qa_db_select_with_pending(qa_db_category_nav_selectspec(array(), false, false, true));
        foreach($temp_categories as $index => $temp_category){
            $qa_content['navigation']['main'][$index]=array(
                'url' => qa_path_html('questions/'.$temp_category['backpath']),
                'label' => $temp_category['title'],
            );
        }
